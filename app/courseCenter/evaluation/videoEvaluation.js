...
export default class TeacherEvaluation extends Component{
    constructor(props) {
        super(props);
        this.state={
            isRefershing:false
    ...
    renderStar(num=0){
        ...
        for(let i=0;i<starCount; i++){
            ...
            let plusIndex=i;
            starList.push(<span style={{color:color,cursor:'pointer',fontSize:'18px'}} name={i} key={"star_"+i} onClick={()=>_self.setTeacherStar(plusIndex)}> {emptyStar}</span>)
        }
        return starList;
    }
